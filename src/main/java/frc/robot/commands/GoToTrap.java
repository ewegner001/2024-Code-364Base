...
public class GoToTrap extends Command {
    ...
    public void initialize() {
        ...
        closestDistance = blueTrapLeftDistance;
        ...
        } else if (closestDistance == redTrapLeftDistance) {
    ...
    public boolean isFinished() {
        ...
        double yError = Math.abs(targetX + s_Swerve.m_poseEstimator.getEstimatedPosition().getY());
